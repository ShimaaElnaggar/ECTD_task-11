...
class _RoomsViewState extends State<RoomsView> {
  List<Item> items = [
    Item(
        header: Image.asset("assets/images/king room.jpg",height: 100,width: 150,fit: BoxFit.fill),
        body: "A room with a king-sized bed.",
        selection: 'King Room'
    ),
    Item(
        header: Image.asset(
            "assets/images/double room.jpg",height: 100,width: 150,fit: BoxFit.fill),
        body: "A room assigned to two people.",
        selection: 'Double Room'
    ),
    Item(
        header: Image.asset("assets/images/family room.jpg", height: 100,width: 150,fit: BoxFit.fill),
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            CustomElevatedButton(onPressed: (){}, title: "Next"),
          ],
        ),
      ),
    );
